function table3_n500() %Gaussian mixture
for i=2
...
save table3_n500.mat th1 th2 th3 th4 cov2 cov3 cov4 samplevar i fails1 fails2 fails3 fails4 e1_set e2_set e3_set e4_set H pValue W n coverage2 coverage3 coverage4 
end
