function table1_n1000()
for p=11
randn('state',p); rand('state',p);
simus=1000;n=1000; s=0.9;
...
save table1_n1000.mat th1 th2 th3  th4 cov2 cov3  cov4 samplevar p s n coverage2 coverage3 coverage4 e1_set e2_set e3_set e4_set e4_set H pValue W
end
