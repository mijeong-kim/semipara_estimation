function table2_n200() %sigma=1.5
for p=19
randn('state',p); rand('state',p);
simus=1000;n=200; mu=0; sigma=1.5;
...
save table2_n200.mat th1 th2 th3 th4 cov2 cov3 cov4 samplevar sigma fails1 fails2 fails3 fails4  e1_set e2_set e3_set e4_set e4_set H pValue W n coverage2 coverage3 coverage4 p
end
